...
def extraerConsulta5(operador, fecha):
    select = session.prepare("SELECT experimento_operador, experimento_instrumento, experimento_fecha, experimento_fecha_comp, medida_intensidad, medida_parametro, medida_longitud FROM medidas_por_operador_fecha WHERE experimento_operador = ? AND experimento_fecha = ?")
    resultados = []
